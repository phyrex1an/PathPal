...
public class TranslatorApi {
	public static boolean translateString(String inputString, DirectionsForm form) throws FileNotFoundException, IOException, UnknownLanguageException {
		String[] words = inputString.split(" ");
		PGF pgf = PGFBuilder.fromFile("locator.pgf");
